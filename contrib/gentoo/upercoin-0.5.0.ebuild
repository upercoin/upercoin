...
DESCRIPTION="UperCoin - a hybrid PoW+PoS energy efficient p2p-cryptocurrency and electronic payment system."
...
src_install() {
	...
	newins "src/qt/res/icons/upercoin-128.png" "${PN}.png"

	make_desktop_entry "${PN}-qt" "Upercoin" "/usr/share/pixmaps/${PN}.png" "Network;P2P;Finance;"

	if use kde; then
		insinto /usr/share/kde4/services
		newins contrib/debian/upercoin-qt.protocol ${PN}.protocol
	fi
}
