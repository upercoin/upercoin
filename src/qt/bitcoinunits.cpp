...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("UperCoins"));
    case mBTC: return QString(QObject::tr("Milli-UperCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-UperCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
