...
unsigned int nStakeMinAge = 60 * 60 * 24 * 3; // 3 days as zero time weight
unsigned int nStakeMaxAge = 60 * 60 * 24 * 30; // 30 days as full weight
...
const string strMessageMagic = "UperCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(unsigned int nBits, int64_t nFees)
{
    ...
    // UperCoin: subsidy is cut in half every 64x multiply of PoW difficulty
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, unsigned int nBits, int64_t nTime, bool bCoinYearOnly)
{
    ...
    if(fTestNet || nTime > STAKE_SWITCH_TIME)
    {
        ...
        // UperCoin: A reasonably continuous curve is used to avoid shock to market
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("upercoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in UperCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // UperCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UperCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "I guess we've come full circle.";
        CTransaction txNew;
        txNew.nTime = 1430330400;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x5964e542044b261a1ebd944b982dbffe264712b5b973bad56ff383fc79a6b2c8"));
        //block.print();
